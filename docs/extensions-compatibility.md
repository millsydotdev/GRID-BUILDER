...
> It's officially unsupported: https://github.com/James-Yu/LaTeX-Workshop/wiki/FAQ#grid-is-not-officially-supported

## Incompatibility due to licensing

The following extensions are not compatible with GRID due to their licensing:
